...
public class CompiladorCisco {
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            System.out.println("2) Analizar Comandos Cisco");
            ...
            switch (valor) {
                ...
                case GENERAR: {
                    ...
                    try {
                        ...
                        Logger.getLogger(CompiladorCisco.class.getName()).log(Level.SEVERE, null, ex);
                    }
    ...
    public static boolean moverArch(String archNombre) {
        ...
        if (arch.exists()) {
            ...
            String nuevoDir = currentRelativePath.toAbsolutePath().toString()
                    ...
                    + "compiladorcisco" + File.separator + arch.getName();
